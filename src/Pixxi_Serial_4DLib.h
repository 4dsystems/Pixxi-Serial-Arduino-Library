...
{
	public:
		Pixxi_Serial_4DLib(Stream * virtualPort, void (*setBaudRateHndl)(unsigned long) = NULL);
		Pixxi_Serial_4DLib(HardwareSerial * serial);
#ifdef SoftwareSerial_h		
		Pixxi_Serial_4DLib(SoftwareSerial * serial);
#endif
#ifdef AltSoftSerial_h
	    Pixxi_Serial_4DLib(AltSoftSerial * serial);
#endif
	...
	private:
		...
		void (Pixxi_Serial_4DLib::*setBaudRateInternal)(unsigned long newRate);
