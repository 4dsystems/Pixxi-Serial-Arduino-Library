...
// PmmC, Internal and Inherent Widget Control offsets
#define WIDGET_XPOS             0  // RAM xpos
#define WIDGET_YPOS             1  // RAM ypos
#define WIDGET_WIDTH            2  // RAM width, needed for touch
#define WIDGET_HEIGHT           3  // RAM height, needed for touch
#define WIDGET_XOTHER           4  // RAM xpos 'other' (Int. Flash widgets only)
#define WIDGET_LO_WORD          4  // Flash offset low word (Ext. Flash widgets only)
#define WIDGET_YOTHER           5  // RAM ypos 'other' (Int. Flash widgets only)
#define WIDGET_HI_WORD          5  // Flash offset high word (Ext. Flash widgets only)
#define WIDGET_FLAGS            6  // RAM flags
#define WIDGET_TAG              7  // RAM user variable #1
#define WIDGET_TAG2             8  // RAM user variable #2
#define WIDGET_VAL1             9  // RAM current value
#define WIDGET_DELAY            10 // Inter frame delay (GCI Flash widgets only)
#define WIDGET_FRAMES           11 // Number of frames (GCI Flash widgets only)

// PmmC, Internal and Inherent Widget Attribute Flags
#define WIDGET_F_TOUCH_ENABLE   0x8000  // Set to disable touch for this image, (default=1 for movie, 0 for image)
#define WIDGET_F_INTERNAL       0x4000  // Internal use only (force redraw on next write)
#define WIDGET_F_INITIALISED    0x2000  // Flag when ‘base gauge needle, etc.’ is done
#define WIDGET_F_UNDRAW_ONLY    0x1000  // Set to prevent draw of new needle
#define WIDGET_F_INPUT          0x0800  // Set if this is an input (Used only with the IDE)
#define WIDGET_F_FLASH          0x0400  // set if this is a flash based widget
#define WIDGET_F_RESERVED       0x03c0  // bits 9-6 reserved
...
// Gradient Options
#define GRAD_DOWN               32
#define GRAD_RIGHT              48
#define GRAD_UP                 64
#define GRAD_LEFT               80
#define GRAD_WAVE_VER           96
#define GRAD_WAVE_HOR           112

// gfx_Scale Options
#define SCALE_TL                1
#define SCALE_BR                2
#define SCALE_CENTRE            3   
#define SCALE_NONE              0
#define SCALE_TICKS_TL          4   
#define SCALE_TICKS_BR          8  
#define SCALE_TICKS_BOTH        12     
#define SCALE_TICKS_NONE        0   
#define SCALE_VERT              16
#define SCALE_HORZ              0
#define SCALE_END_ALIGN         32       
#define SCALE_NO_END_ALIGN      0     
#define SCALE_SHOW_ZERO         64    
#define SCALE_HIDE_ZERO         0  

// gfx_Switch1 and gfx_Switch2 options
#define SWITCH_F_ORIENT_HORZ    0
#define SWITCH_F_ORIENT_VERT    1

// gfx_SliderX Options
#define SLIDER_F_ORIENT_HORZ    0
#define SLIDER_F_ORIENT_VERT    1
#define SLIDER_F_TICKS          2
#define SLIDER_F_VALUE_IND      4
#define SLIDER_F_ALT_MODE       8

// gfx_Gauge Options
#define GAUGE_F_VERT                0
#define GAUGE_F_TOPRIGHT            1
#define GAUGE_F_HORZ                2

// gfx_RulerGauge Options
#define RULERGAUGE_F_TICKS_TL           1
#define RULERGAUGE_F_TICKS_BR           0
#define RULERGAUGE_F_ORIENT_HORZ        0
#define RULERGAUGE_F_ORIENT_VERT        2

// gfx_AngularMeter Options
#define ANGULAR_F_LABEL_STRINGS     1
#define ANGULAR_F_BG_TRANSPARENT    2
#define ANGULAR_F_TICK_PCT_COLOUR   4
#define ANGULAR_F_TEXT_PCT_COLOUR   8

// gfx_AngularMeter Needle Types
#define NEEDLE_F_LINE               0   // simple needle pointer
#define NEEDLE_F_RECTANGLE          1   //
#define NEEDLE_F_POINTRECTANGLE     2   //
#define NEEDLE_F_TRIANGLE           3   //
#define NEEDLE_F_DOUBLETRIANGLE     4   //
#define NEEDLE_F_ROUNDEDRECTANGLE   5   //

// gfx_Dial Options
#define DIAL_F_LABEL_STRINGS            0x0001
#define DIAL_F_BG_TRANSPARENT           0x0002
#define DIAL_F_HANDLE_CIRCLE            0x0000
#define DIAL_F_HANDLE_TRIANGLE          0x0010
#define DIAL_F_HANDLE_RECTANGLE         0x0020
#define DIAL_F_HANDLE_LINE              0x0030
#define DIAL_F_INDICATOR_CIRCLE         0x0000
#define DIAL_F_INDICATOR_TRIANGLE       0x0100
#define DIAL_F_INDICATOR_RECTANGLE      0x0200
#define DIAL_F_INDICATOR_LINE           0x0300

// gfx_LedDigits Options
#define LEDDIGITS_F_GENERAL             0x0003
#define LEDDIGITS_F_FIXED               0x0002
#define LEDDIGITS_F_SCIENTIFIC          0x0001
#define LEDDIGITS_F_INT16               0x0000
#define LEDDIGITS_F_INT32               0x0004
#define LEDDIGITS_F_FLOAT               0x0008
#define LEDDIGITS_F_UNSIGNED            0x0000
#define LEDDIGITS_F_SIGNED              0x0010
#define LEDDIGITS_F_LEADING0            0x0020
#define LEDDIGITS_F_LEADINGb            0x0000
#define LEDDIGITS_F_DP_DOT              0x0000
#define LEDDIGITS_F_DP_COMMA            0x0040

// gfx_MediaButton/Led Styles
#define MEDIA_ROUND                     0x0076
#define MEDIA_ROUND_FLAT                0x2070
#define MEDIA_ROUND_MEDIUM_FLAT         0x0073
#define MEDIA_SQUARE                    0x1000
#define MEDIA_SQUARE_FLAT               0x3000
#define MEDIA_ROUND_RAISED_SUNKEN       0x007D
#define MEDIA_ROUND_SUNKEN_RAISED       0x00F6
#define MEDIA_ROUND_SUNKEN_FLAT         0x20D0
#define MEDIA_ROUND_SUNKEN_SUNKEN       0x00FD
#define MEDIA_SQUARE_RAISED_SUNKEN      0x107D
#define MEDIA_SQUARE_SUNKEN_RAISED      0x10F6
#define MEDIA_SQUARE_SUNKEN_FLAT        0x30C0
#define MEDIA_SQUARE_SUNKEN_SUNKEN      0x10FD
#define MEDIA_HALFMOON_UP_SUNKEN        0x8C7F
#define MEDIA_HALFMOON_DOWN_SUNKEN      0x837F
#define MEDIA_HALFMOON_LEFT_SUNKEN      0x8A7F
#define MEDIA_HALFMOON_RIGHT_SUNKEN     0x857F
#define MEDIA_HALFMOON_UP_RAISED        0x8C76
#define MEDIA_HALFMOON_DOWN_RAISED      0x8376
#define MEDIA_HALFMOON_LEFT_RAISED      0x8A76
#define MEDIA_HALFMOON_RIGHT_RAISED     0x8576
#define MEDIA_HALFMOON_UP_FLAT          0xAC70
#define MEDIA_HALFMOON_DOWN_FLAT        0xA370
#define MEDIA_HALFMOON_LEFT_FLAT        0xAA70
#define MEDIA_HALFMOON_RIGHT_FLAT       0xA570
#define MEDIA_KEYPAD_ROUND              0xE060
#define MEDIA_KEYPAD_SQUARE             0xF060
#define MEDIA_UP                        0x4C53
#define MEDIA_DOWN                      0x4353
#define MEDIA_LEFT                      0x4A53
#define MEDIA_RIGHT                     0x4553
#define MEDIA_UP_FLAT                   0x6C53
#define MEDIA_DOWN_FLAT                 0x6353
#define MEDIA_LEFT_FLAT                 0x6A53
#define MEDIA_RIGHT_FLAT                0x6553
#define MEDIA_LED1_ROUND                0x9B08
#define MEDIA_LED1_SQUARE               0x9B0A
#define MEDIA_LED1_ROUND_FLAT           0x9B09
#define MEDIA_LED1_SQUARE_FLAT          0x9B0B
#define MEDIA_LED1_ROUND_SUNK           0x9B18
#define MEDIA_LED1_SQUARE_SUNK          0x9B1A
#define MEDIA_LED2_ROUND                0x9750
#define MEDIA_LED2_SQUARE               0x9752
#define MEDIA_LED2_ROUND_FLAT           0x9751
#define MEDIA_LED2_SQUARE_FLAT          0x9753
#define MEDIA_LED2_ROUND_SUNK           0x9754
#define MEDIA_LED2_SQUARE_SUNK          0x9756

// gfx_MediaButton/Led Icons
#define MEDIA_NO_SYMBOL                 0xFFFF
#define MEDIA_TEXT_SYMBOL               0xFFFE
#define MEDIA_INC_VERTICAL              0x00
#define MEDIA_DEC_VERTICAL              0x10
#define MEDIA_INC_HORIZONTAL            0x38
#define MEDIA_DEC_HORIZONTAL            0x28
#define MEDIA_INC_HORIZONTAL_THIN       0x3A
#define MEDIA_DEC_HORIZONTAL_THIN       0x2A
#define MEDIA_INC_VERTICAL_THIN         0x02
#define MEDIA_DEC_VERTICAL_THIN         0x12
#define MEDIA_PLAY                      0x58
#define MEDIA_PAUSE                     0x49
#define MEDIA_NEXT                      0x3A
#define MEDIA_PREVIOUS                  0x2A
#define MEDIA_FAST_FORWARD              0x39
#define MEDIA_REWIND                    0x29
#define MEDIA_STOP                      0x68
#define MEDIA_PLUS                      0x78
#define MEDIA_MINUS                     0x88
#define MEDIA_PLUS_THIN                 0x7A
#define MEDIA_MINUS_THIN                0x8A
#define MEDIA_TICK                      0x90
#define MEDIA_CROSS                     0xA9
#define MEDIA_HOME                      0xB0


// gfx_MediaRotary Styles
#define MEDIAROTARY_Style00             0x23E0
#define MEDIAROTARY_Style01             0xABF0
#define MEDIAROTARY_Style02             0x3000
#define MEDIAROTARY_Style03             0xB800
#define MEDIAROTARY_Style04             0x30F8
#define MEDIAROTARY_Style05             0xB0F8
#define MEDIAROTARY_Style06             0x30FE
#define MEDIAROTARY_Style07             0xB0FE
#define MEDIAROTARY_Style08             0x23FE
#define MEDIAROTARY_Style09             0xA3FE
#define MEDIAROTARY_Style10             0x2300
#define MEDIAROTARY_Style11             0xB200
#define MEDIAROTARY_Style12             0x23FA
#define MEDIAROTARY_Style13             0xB2FA
...
#define F_gfx_Scale -342
#define F_gfx_Panel2 -313
#define F_gfx_Button4 -340
#define F_gfx_Switch -339
#define F_gfx_Slider5 -337
#define F_gfx_RulerGauge -343
#define F_gfx_Dial -315
#define F_gfx_Led -341
#define F_gfx_Gauge -316
#define F_gfx_AngularMeter -312
#define F_gfx_LedDigit -319
#define F_gfx_LedDigits -318
...
#define F_sendWordArrayToRAM 41
#define F_sendByteArrayToRAM 42
#define F_widget_InitGradRAM 43

#define F_widget_Create           -322
#define F_widget_Add              -323
#define F_widget_Delete           -324
#define F_widget_Realloc          -327
//#define F_widget_LoadFlash        -326
//#define F_widget_Show             -325
#define F_widget_SetWord          -332
#define F_widget_GetWord          -328
#define F_widget_SetPosition      -329
#define F_widget_Enable           -330
#define F_widget_Disable          -331
#define F_widget_SetAttributes    -333
#define F_widget_ClearAttributes  -334
#define F_widget_Touched          -335
//#define F_widget_FontID           -336    