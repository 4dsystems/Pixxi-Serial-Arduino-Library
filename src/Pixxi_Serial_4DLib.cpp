...
Pixxi_Serial_4DLib::Pixxi_Serial_4DLib(Stream * virtualPort, void (*setBaudRateHndl)(unsigned long)) { 
    _virtualPort = virtualPort; 
    setBaudRateExternal = setBaudRateHndl;
    setBaudRateInternal = &Pixxi_Serial_4DLib::exSetBaudRateHndl;
    unknownSerial = true;
...
Pixxi_Serial_4DLib::Pixxi_Serial_4DLib(HardwareSerial * serial) { 
    _virtualPort = (Stream *)serial; 
    setBaudRateInternal = &Pixxi_Serial_4DLib::hwSetBaudRateHndl;
#if !defined(ARDUINO_ARCH_SAMD) || (ARDUINO_ARCH_SAM)
	//Only done for non-SAMD/SAM architectures
	_virtualPort->flush();
#endif
...
Pixxi_Serial_4DLib::Pixxi_Serial_4DLib(SoftwareSerial * serial) { 
    _virtualPort = (Stream *)serial; 
    setBaudRateInternal = &Pixxi_Serial_4DLib::swSetBaudRateHndl;
#if !defined(ARDUINO_ARCH_SAMD) || (ARDUINO_ARCH_SAM)
	//Only done for non-SAMD/SAM architectures
	_virtualPort->flush();
#endif
...
Pixxi_Serial_4DLib::Pixxi_Serial_4DLib(AltSoftSerial * serial) { 
    _virtualPort = (Stream *)serial; 
    setBaudRateInternal = &Pixxi_Serial_4DLib::alSetBaudRateHndl;
#if !defined(ARDUINO_ARCH_SAMD) || (ARDUINO_ARCH_SAM)
	//Only done for non-SAMD/SAM architectures
	_virtualPort->flush();
#endif
...
void Pixxi_Serial_4DLib::WriteWords(word * Source, int Size)
{
  word wk ;
  int i ;
  for (i = 0; i < Size; i++)
...
word Pixxi_Serial_4DLib::GetWord(void)
{
...
word Pixxi_Serial_4DLib::GetAckResp(void)
{
	GetAck() ;
	return GetWord() ;
}

word Pixxi_Serial_4DLib::GetAckRes2Words(word * word1, word * word2)
{
	int Result ;
	GetAck() ;
	Result = GetWord() ;
...
void Pixxi_Serial_4DLib::GetAck2Words(word * word1, word * word2)
{
	GetAck() ;
	*word1 = GetWord() ;
	*word2 = GetWord() ;
...
word Pixxi_Serial_4DLib::GetAckResSector(t4DSector Sector)
{
	int Result ;
	GetAck() ;
	Result = GetWord() ;
...
word Pixxi_Serial_4DLib::GetAckResStr(char * OutStr)
{
	int Result ;
	GetAck() ;
	Result = GetWord() ;
...
word Pixxi_Serial_4DLib::GetAckResData(t4DByteArray OutData, word size)
{
	int Result ;
	GetAck() ;
	Result = GetWord() ;
...
word Pixxi_Serial_4DLib::bus_In()
{
...
void Pixxi_Serial_4DLib::bus_Out(word Bits)
{
...
word Pixxi_Serial_4DLib::bus_Read()
{
...
void Pixxi_Serial_4DLib::bus_Set(word IOMap)
{
...
void Pixxi_Serial_4DLib::bus_Write(word Bits)
{
...
word Pixxi_Serial_4DLib::charheight(char  TestChar)
{
...
word Pixxi_Serial_4DLib::charwidth(char  TestChar)
{
...
word Pixxi_Serial_4DLib::file_Close(word  Handle)
{
...
word Pixxi_Serial_4DLib::file_Count(char *  Filename)
{
...
word Pixxi_Serial_4DLib::file_Dir(char *  Filename)
{
...
word Pixxi_Serial_4DLib::file_Erase(char *  Filename)
{
...
word Pixxi_Serial_4DLib::file_Error()
{
...
word Pixxi_Serial_4DLib::file_Exec(char *  Filename, word  ArgCount, t4DWordArray  Args)
{
...
word Pixxi_Serial_4DLib::file_Exists(char *  Filename)
{
...
word Pixxi_Serial_4DLib::file_FindFirst(char *  Filename)
{
...
word Pixxi_Serial_4DLib::file_FindNext()
{
...
char Pixxi_Serial_4DLib::file_GetC(word  Handle)
{
...
word Pixxi_Serial_4DLib::file_GetS(char *  StringIn, word  Size, word  Handle)
{
...
word Pixxi_Serial_4DLib::file_GetW(word  Handle)
{
...
word Pixxi_Serial_4DLib::file_Image(word  X, word  Y, word  Handle)
{
...
word Pixxi_Serial_4DLib::file_Index(word  Handle, word  HiSize, word  LoSize, word  Recordnum)
{
...
word Pixxi_Serial_4DLib::file_LoadFunction(char *  Filename)
{
...
word Pixxi_Serial_4DLib::file_LoadImageControl(char *  Datname, char *  GCIName, word  Mode)
{
...
word Pixxi_Serial_4DLib::file_LoadImageControl(word HiOffset, word LoOffset, word Mode)
{
  _virtualPort->print((char)(F_file_LoadImageControl >> 8));
  _virtualPort->print((char)(F_file_LoadImageControl));
  _virtualPort->print((char)(HiOffset >> 8));
  _virtualPort->print((char)(HiOffset));
  _virtualPort->print((char)(LoOffset >> 8));
  _virtualPort->print((char)(LoOffset));
  _virtualPort->print((char)(Mode >> 8));
  _virtualPort->print((char)(Mode));
  return GetAckResp();
}

word Pixxi_Serial_4DLib::file_LoadImageControl(int HiOffset, int LoOffset, int Mode)
{
  return file_LoadImageControl((word)HiOffset, (word)LoOffset, (word)Mode);
}

word Pixxi_Serial_4DLib::file_Mount()
{
...
word Pixxi_Serial_4DLib::file_Open(char *  Filename, char  Mode)
{
...
word Pixxi_Serial_4DLib::file_PlayWAV(char *  Filename)
{
...
word Pixxi_Serial_4DLib::file_PutC(char  Character, word  Handle)
{
...
word Pixxi_Serial_4DLib::file_PutS(char *  StringOut, word  Handle)
{
...
word Pixxi_Serial_4DLib::file_PutW(word  Word, word  Handle)
{
...
word Pixxi_Serial_4DLib::file_Read(t4DByteArray  Data, word  Size, word  Handle)
{
...
word Pixxi_Serial_4DLib::file_Rewind(word  Handle)
{
...
word Pixxi_Serial_4DLib::file_Run(char *  Filename, word  ArgCount, t4DWordArray  Args)
{
...
word Pixxi_Serial_4DLib::file_ScreenCapture(word  X, word  Y, word  Width, word  Height, word  Handle)
{
...
word Pixxi_Serial_4DLib::file_Seek(word  Handle, word  HiWord, word  LoWord)
{
...
word Pixxi_Serial_4DLib::file_Size(word  Handle, word *  HiWord, word *  LoWord)
{
...
word Pixxi_Serial_4DLib::file_Tell(word  Handle, word *  HiWord, word *  LoWord)
{
...
word Pixxi_Serial_4DLib::file_Write(word  Size, t4DByteArray  Source, word  Handle)
{
...
word Pixxi_Serial_4DLib::gfx_BevelShadow(word  Value)
{
...
word Pixxi_Serial_4DLib::gfx_BevelWidth(word  Value)
{
...
word Pixxi_Serial_4DLib::gfx_BGcolour(word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_Button(word  Up, word  x, word  y, word  buttonColour, word  txtColour, word  font, word  txtWidth, word  txtHeight, char *   text)
{
...
void Pixxi_Serial_4DLib::gfx_ChangeColour(word  OldColor, word  NewColor)
{
...
void Pixxi_Serial_4DLib::gfx_Circle(word  X, word  Y, word  Radius, word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_CircleFilled(word  X, word  Y, word  Radius, word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_Clipping(word  OnOff)
{
...
void Pixxi_Serial_4DLib::gfx_ClipWindow(word  X1, word  Y1, word  X2, word  Y2)
{
...
word Pixxi_Serial_4DLib::gfx_Contrast(word  Contrast)
{
...
void Pixxi_Serial_4DLib::gfx_Ellipse(word  X, word  Y, word  Xrad, word  Yrad, word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_EllipseFilled(word  X, word  Y, word  Xrad, word  Yrad, word  Color)
{
...
word Pixxi_Serial_4DLib::gfx_FrameDelay(word  Msec)
{
...
word Pixxi_Serial_4DLib::gfx_Get(word  Mode)
{
...
word Pixxi_Serial_4DLib::gfx_GetPixel(word  X, word  Y)
{
...
void Pixxi_Serial_4DLib::gfx_Line(word  X1, word  Y1, word  X2, word  Y2, word  Color)
{
...
word Pixxi_Serial_4DLib::gfx_LinePattern(word  Pattern)
{
...
void Pixxi_Serial_4DLib::gfx_LineTo(word  X, word  Y)
{
...
void Pixxi_Serial_4DLib::gfx_MoveTo(word  X, word  Y)
{
...
word Pixxi_Serial_4DLib::gfx_Orbit(word  Angle, word  Distance, word *  Xdest, word *  Ydest)
{
...
word Pixxi_Serial_4DLib::gfx_OutlineColour(word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_Panel(word  Raised, word  X, word  Y, word  Width, word  Height, word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_Polygon(word  n, t4DWordArray  Xvalues, t4DWordArray  Yvalues, word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_PolygonFilled(word  n, t4DWordArray  Xvalues, t4DWordArray  Yvalues, word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_Polyline(word  n, t4DWordArray  Xvalues, t4DWordArray  Yvalues, word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_PutPixel(word  X, word  Y, word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_Rectangle(word  X1, word  Y1, word  X2, word  Y2, word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_RectangleFilled(word  X1, word  Y1, word  X2, word  Y2, word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_ScreenCopyPaste(word  Xs, word  Ys, word  Xd, word  Yd, word  Width, word  Height)
{
...
word Pixxi_Serial_4DLib::gfx_ScreenMode(word  ScreenMode)
{
...
void Pixxi_Serial_4DLib::gfx_Set(word  Func, word  Value)
{
...
word Pixxi_Serial_4DLib::gfx_Slider(word  Mode, word  X1, word  Y1, word  X2, word  Y2, word  Color, word  Scale, word  Value)
{
...
word Pixxi_Serial_4DLib::gfx_Transparency(word  OnOff)
{
...
word Pixxi_Serial_4DLib::gfx_TransparentColour(word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_Triangle(word  X1, word  Y1, word  X2, word  Y2, word  X3, word  Y3, word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_TriangleFilled(word  X1, word  Y1, word  X2, word  Y2, word  X3, word  Y3, word  Color)
{
...
void Pixxi_Serial_4DLib::gfx_Button4(word value, word hndl, word params) {
    _virtualPort->write((char)(F_gfx_Button4 >> 8));
    _virtualPort->write((char)(F_gfx_Button4));
    _virtualPort->write((char)(value >> 8));
    _virtualPort->write((char)(value));
    _virtualPort->write((char)(hndl >> 8));
    _virtualPort->write((char)(hndl));
    _virtualPort->write((char)(params >> 8));
    _virtualPort->write((char)(params));
    GetAck();
}

void Pixxi_Serial_4DLib::gfx_Switch(word value, word hndl, word params) {
    _virtualPort->write((char)(F_gfx_Switch >> 8));
    _virtualPort->write((char)(F_gfx_Switch));
    _virtualPort->write((char)(value >> 8));
    _virtualPort->write((char)(value));
    _virtualPort->write((char)(hndl >> 8));
    _virtualPort->write((char)(hndl));
...
void Pixxi_Serial_4DLib::gfx_Slider5(word value, word hndl, word params) {
    _virtualPort->write((char)(F_gfx_Slider5 >> 8));
    _virtualPort->write((char)(F_gfx_Slider5));
    _virtualPort->write((char)(value >> 8));
    _virtualPort->write((char)(value));
    _virtualPort->write((char)(hndl >> 8));
    _virtualPort->write((char)(hndl));
...
void Pixxi_Serial_4DLib::gfx_Dial(word value, word hndl, word params) {
    _virtualPort->write((char)(F_gfx_Dial >> 8));
    _virtualPort->write((char)(F_gfx_Dial));
    _virtualPort->write((char)(value >> 8));
    _virtualPort->write((char)(value));
    _virtualPort->write((char)(hndl >> 8));
    _virtualPort->write((char)(hndl));
...
void Pixxi_Serial_4DLib::gfx_Led(word value, word hndl, word params) {
    _virtualPort->write((char)(F_gfx_Led >> 8));
    _virtualPort->write((char)(F_gfx_Led));
    _virtualPort->write((char)(value >> 8));
    _virtualPort->write((char)(value));
    _virtualPort->write((char)(hndl >> 8));
    _virtualPort->write((char)(hndl));
...
void Pixxi_Serial_4DLib::gfx_Gauge(word value, word hndl, word params) {
    _virtualPort->write((char)(F_gfx_Gauge >> 8));
    _virtualPort->write((char)(F_gfx_Gauge));
    _virtualPort->write((char)(value >> 8));
    _virtualPort->write((char)(value));
    _virtualPort->write((char)(hndl >> 8));
    _virtualPort->write((char)(hndl));
...
void Pixxi_Serial_4DLib::gfx_AngularMeter(word value, word hndl, word params) {
    _virtualPort->write((char)(F_gfx_AngularMeter >> 8));
    _virtualPort->write((char)(F_gfx_AngularMeter));
    _virtualPort->write((char)(value >> 8));
    _virtualPort->write((char)(value));
    _virtualPort->write((char)(hndl >> 8));
    _virtualPort->write((char)(hndl));
...
void Pixxi_Serial_4DLib::gfx_LedDigit(word x, word y, word digitSize, word onColour, word offColour, word value) {
    _virtualPort->write((char)(F_gfx_LedDigit >> 8));
    _virtualPort->write((char)(F_gfx_LedDigit));
    _virtualPort->write((char)(x >> 8));
    _virtualPort->write((char)(x));
    _virtualPort->write((char)(y >> 8));
    _virtualPort->write((char)(y));
    _virtualPort->write((char)(digitSize >> 8));
    _virtualPort->write((char)(digitSize));
    _virtualPort->write((char)(onColour >> 8));
    _virtualPort->write((char)(onColour));
    _virtualPort->write((char)(offColour >> 8));
    _virtualPort->write((char)(offColour));
    _virtualPort->write((char)(value >> 8));
    _virtualPort->write((char)(value));
    GetAck();
}

void Pixxi_Serial_4DLib::gfx_LedDigits(word value, word hndl, word params) {
    _virtualPort->write((char)(F_gfx_LedDigits >> 8));
    _virtualPort->write((char)(F_gfx_LedDigits));
    _virtualPort->write((char)(value >> 8));
    _virtualPort->write((char)(value));
    _virtualPort->write((char)(hndl >> 8));
    _virtualPort->write((char)(hndl));
...
void Pixxi_Serial_4DLib::gfx_RulerGauge(word value, word hndl, word params) {
    _virtualPort->write((char)(F_gfx_RulerGauge >> 8));
    _virtualPort->write((char)(F_gfx_RulerGauge));
    _virtualPort->write((char)(value >> 8));
    _virtualPort->write((char)(value));
    _virtualPort->write((char)(hndl >> 8));
    _virtualPort->write((char)(hndl));
...
word Pixxi_Serial_4DLib::img_ClearAttributes(word  Handle, word  Index, word  Value)
{
...
word Pixxi_Serial_4DLib::img_Darken(word  Handle, word  Index)
{
...
word Pixxi_Serial_4DLib::img_Disable(word  Handle, word  Index)
{
...
word Pixxi_Serial_4DLib::img_Enable(word  Handle, word  Index)
{
...
word Pixxi_Serial_4DLib::img_GetWord(word  Handle, word  Index, word  Offset )
{
...
word Pixxi_Serial_4DLib::img_Lighten(word  Handle, word  Index)
{
...
word Pixxi_Serial_4DLib::img_SetAttributes(word  Handle, word  Index, word  Value)
{
...
word Pixxi_Serial_4DLib::img_SetPosition(word  Handle, word  Index, word  Xpos, word  Ypos)
{
...
word Pixxi_Serial_4DLib::img_SetWord(word  Handle, word  Index, word  Offset , word  Word)
{
...
word Pixxi_Serial_4DLib::img_Show(word  Handle, word  Index)
{
...
word Pixxi_Serial_4DLib::img_Touched(word  Handle, word  Index)
{
...
void Pixxi_Serial_4DLib::img_FunctionCall(word imgHndl, word index, word value, word hndl, word params, word argCount, word strMap) {
    _virtualPort->print((char)(F_img_FunctionCall >> 8));
    _virtualPort->print((char)(F_img_FunctionCall));
    _virtualPort->print((char)(imgHndl >> 8));
    _virtualPort->print((char)(imgHndl));
    _virtualPort->print((char)(index >> 8));
    _virtualPort->print((char)(index));
    _virtualPort->print((char)(value >> 8));
    _virtualPort->print((char)(value));
    _virtualPort->print((char)(hndl >> 8));
    _virtualPort->print((char)(hndl));
    _virtualPort->print((char)(params >> 8));
    _virtualPort->print((char)(params));
    _virtualPort->print((char)(argCount >> 8));
    _virtualPort->print((char)(argCount));
    _virtualPort->print((char)(strMap >> 8));
    _virtualPort->print((char)(strMap));    
    GetAck();
}

word Pixxi_Serial_4DLib::media_Flush()
{
...
void Pixxi_Serial_4DLib::media_Image(word  X, word  Y)
{
...
word Pixxi_Serial_4DLib::media_Init()
{
...
word Pixxi_Serial_4DLib::media_RdSector(t4DSector  SectorIn)
{
...
word Pixxi_Serial_4DLib::media_ReadByte()
{
...
word Pixxi_Serial_4DLib::media_ReadWord()
{
...
void Pixxi_Serial_4DLib::media_SetAdd(word  HiWord, word  LoWord)
{
...
void Pixxi_Serial_4DLib::media_SetSector(word  HiWord, word  LoWord)
{
...
void Pixxi_Serial_4DLib::media_Video(word  X, word  Y)
{
...
void Pixxi_Serial_4DLib::media_VideoFrame(word  X, word  Y, word  Framenumber)
{
...
word Pixxi_Serial_4DLib::media_WriteByte(word  Byte)
{
...
word Pixxi_Serial_4DLib::media_WriteWord(word  Word)
{
...
word Pixxi_Serial_4DLib::media_WrSector(t4DSector  SectorOut)
{
...
word Pixxi_Serial_4DLib::mem_Alloc(word size)
{
  _virtualPort->write((char)(F_mem_Alloc >> 8));
  _virtualPort->write((char)(F_mem_Alloc));
  _virtualPort->write((char)(size >> 8));
  _virtualPort->write((char)(size));
  return GetAckResp();
}

word Pixxi_Serial_4DLib::mem_Free(word  Handle)
{
...
word Pixxi_Serial_4DLib::mem_Heap()
{
...
word Pixxi_Serial_4DLib::pin_HI(word Pin)
{
...
word Pixxi_Serial_4DLib::peekM(word  Address)
{
...
word Pixxi_Serial_4DLib::pin_LO(word Pin)
{
...
word Pixxi_Serial_4DLib::pin_Read(word Pin)
{
...
word Pixxi_Serial_4DLib::pin_Set(word Mode, word Pin)
{
...
void Pixxi_Serial_4DLib::putCH(word  WordChar)
{
...
void Pixxi_Serial_4DLib::pokeM(word  Address, word  WordValue)
{
...
word Pixxi_Serial_4DLib::putstr(char *  InString)
{
...
#ifdef AVR
void Pixxi_Serial_4DLib::print(const __FlashStringHelper *ifsh)
{
...
void Pixxi_Serial_4DLib::print(const String &s)
{
	int len = s.length();
	char arr[len + 1];
...
void Pixxi_Serial_4DLib::print(char c)
{
  putCH(c);
}

void Pixxi_Serial_4DLib::print(unsigned char b, int base)
{
  print((unsigned long) b, base);
}

void Pixxi_Serial_4DLib::print(int n, int base)
{
  print((long) n, base);
}

void Pixxi_Serial_4DLib::print(unsigned int n, int base)
{
  print((unsigned long) n, base);
}

void Pixxi_Serial_4DLib::print(long n, int base)
{
...
void Pixxi_Serial_4DLib::print(unsigned long n, int base)
{
  printNumber(n, base);
}

void Pixxi_Serial_4DLib::print(double n, int digits)
{
  printFloat(n, digits);
}
...
void Pixxi_Serial_4DLib::println(const __FlashStringHelper *ifsh)
{
  print(ifsh);
  putCH('\n');
  putCH('\r');
...
void Pixxi_Serial_4DLib::println(const String &s)
{
  print(s);
  putCH('\n');
  putCH('\r');
...
void Pixxi_Serial_4DLib::println(char c)
{
  print((char)c);
  putCH('\n');
  putCH('\r');
...
void Pixxi_Serial_4DLib::println(unsigned char b, int base)
{
...
void Pixxi_Serial_4DLib::println(int num, int base)
{
  print((int)num, base);
  putCH('\n');
  putCH('\r');
...
void Pixxi_Serial_4DLib::println(unsigned int num, int base)
{
...
void Pixxi_Serial_4DLib::println(long num, int base)
{
  print((long)num, base);
  putCH('\n');
  putCH('\r');
...
void Pixxi_Serial_4DLib::println(unsigned long num, int base)
{
...
void Pixxi_Serial_4DLib::println(double num, int digits)
{
...
void Pixxi_Serial_4DLib::printFloat(double number, uint8_t digits) 
{ 
  size_t n = 0;
...
void Pixxi_Serial_4DLib::snd_BufSize(word  Bufsize)
{
...
word Pixxi_Serial_4DLib::snd_Pitch(word  Pitch)
{
...
word Pixxi_Serial_4DLib::snd_Playing()
{
...
void Pixxi_Serial_4DLib::snd_Volume(word  Volume)
{
...
word Pixxi_Serial_4DLib::sys_Sleep(word  Units)
{
...
void Pixxi_Serial_4DLib::touch_DetectRegion(word  X1, word  Y1, word  X2, word  Y2)
{
...
word Pixxi_Serial_4DLib::touch_Get(word  Mode)
{
...
void Pixxi_Serial_4DLib::touch_Set(word  Mode)
{
...
word Pixxi_Serial_4DLib::txt_Attributes(word  Attribs)
{
...
word Pixxi_Serial_4DLib::txt_BGcolour(word  Color)
{
...
word Pixxi_Serial_4DLib::txt_Bold(word  Bold)
{
...
word Pixxi_Serial_4DLib::txt_FGcolour(word  Color)
{
...
word Pixxi_Serial_4DLib::txt_FontID(word  FontNumber)
{
...
word Pixxi_Serial_4DLib::txt_Height(word  Multiplier)
{
...
word Pixxi_Serial_4DLib::txt_Inverse(word  Inverse)
{
...
word Pixxi_Serial_4DLib::txt_Italic(word  Italic)
{
...
void Pixxi_Serial_4DLib::txt_MoveCursor(word  Line, word  Column)
{
...
word Pixxi_Serial_4DLib::txt_Opacity(word  TransparentOpaque)
{
...
void Pixxi_Serial_4DLib::txt_Set(word  Func, word  Value)
{
...
word Pixxi_Serial_4DLib::txt_Underline(word  Underline)
{
...
word Pixxi_Serial_4DLib::txt_Width(word  Multiplier)
{
...
word Pixxi_Serial_4DLib::txt_Wrap(word  Position)
{
...
word Pixxi_Serial_4DLib::txt_Xgap(word  Pixels)
{
...
word Pixxi_Serial_4DLib::txt_Ygap(word  Pixels)
{
...
word Pixxi_Serial_4DLib::file_CallFunction(word  Handle, word  ArgCount, t4DWordArray  Args)
{
...
word Pixxi_Serial_4DLib::sys_GetModel(char *  ModelStr)
{
...
word Pixxi_Serial_4DLib::sys_GetVersion()
{
...
word Pixxi_Serial_4DLib::sys_GetPmmC()
{
...
word Pixxi_Serial_4DLib::writeString(word  Handle, char *  StringOut)
{
...
word Pixxi_Serial_4DLib::readString(word  Handle, char *  StringIn)
{
...
void Pixxi_Serial_4DLib::blitComtoDisplay(word  X, word  Y, word  Width, word  Height, t4DByteArray  Pixels)
{
...
word Pixxi_Serial_4DLib::file_FindFirstRet(char *  Filename, char *  StringIn)
{
...
word Pixxi_Serial_4DLib::file_FindNextRet(char *  StringIn)
{
...
word Pixxi_Serial_4DLib::widget_Create(word count) {
  _virtualPort->write((char)(F_widget_Create >> 8)) ;
  _virtualPort->write((char)(F_widget_Create)) ;
  _virtualPort->write((char)(count >> 8)) ;
  _virtualPort->write((char)(count));
  return GetAckResp();
}

void Pixxi_Serial_4DLib::widget_Add(word hndl, word index, word widget) {
  _virtualPort->write((char)(F_widget_Add >> 8)) ;
  _virtualPort->write((char)(F_widget_Add)) ;
  _virtualPort->write((char)(hndl >> 8)) ;
  _virtualPort->write((char)(hndl)) ;
  _virtualPort->write((char)(index >> 8)) ;
  _virtualPort->write((char)(index));
  _virtualPort->write((char)(widget >> 8)) ;
  _virtualPort->write((char)(widget));
  GetAck() ;  
}

void Pixxi_Serial_4DLib::widget_Delete(word hndl, word index) {
  _virtualPort->write((char)(F_widget_Delete >> 8)) ;
  _virtualPort->write((char)(F_widget_Delete)) ;
  _virtualPort->write((char)(hndl >> 8)) ;
  _virtualPort->write((char)(hndl)) ;
  _virtualPort->write((char)(index >> 8)) ;
  _virtualPort->write((char)(index));
...
word Pixxi_Serial_4DLib::widget_Realloc(word hndl, word count) {
  _virtualPort->write((char)(F_widget_Realloc >> 8)) ;
  _virtualPort->write((char)(F_widget_Realloc)) ;
  _virtualPort->write((char)(hndl >> 8)) ;
  _virtualPort->write((char)(hndl)) ;
  _virtualPort->write((char)(count >> 8)) ;
  _virtualPort->write((char)(count));
...
word Pixxi_Serial_4DLib::widget_SetWord(word Handle, word  Index, word  Offset , word  Word)
{
  _virtualPort->write((char)(F_widget_SetWord >> 8));
  _virtualPort->write((char)(F_widget_SetWord));
  _virtualPort->write((char)(Handle >> 8));
  _virtualPort->write((char)(Handle));
  _virtualPort->write((char)(Index >> 8));
  _virtualPort->write((char)(Index));
  _virtualPort->write((char)(Offset  >> 8));
  _virtualPort->write((char)(Offset ));
  _virtualPort->write((char)(Word >> 8));
  _virtualPort->write((char)(Word));
  return GetAckResp();
}

word Pixxi_Serial_4DLib::widget_GetWord(word  Handle, word  Index, word  Offset )
{
  _virtualPort->write((char)(F_widget_GetWord >> 8));
  _virtualPort->write((char)(F_widget_GetWord));
  _virtualPort->write((char)(Handle >> 8));
  _virtualPort->write((char)(Handle));
  _virtualPort->write((char)(Index >> 8));
  _virtualPort->write((char)(Index));
...
word Pixxi_Serial_4DLib::widget_SetPosition(word  Handle, word  Index, word  Xpos, word  Ypos)
{
  _virtualPort->write((char)(F_widget_SetPosition >> 8));
  _virtualPort->write((char)(F_widget_SetPosition));
  _virtualPort->write((char)(Handle >> 8));
  _virtualPort->write((char)(Handle));
  _virtualPort->write((char)(Index >> 8));
  _virtualPort->write((char)(Index));
  _virtualPort->write((char)(Xpos >> 8));
  _virtualPort->write((char)(Xpos));
  _virtualPort->write((char)(Ypos >> 8));
  _virtualPort->write((char)(Ypos));
  return GetAckResp();
}

word Pixxi_Serial_4DLib::widget_Enable(word  Handle, word  Index)
{
  _virtualPort->write((char)(F_widget_Enable >> 8));
  _virtualPort->write((char)(F_widget_Enable));
  _virtualPort->write((char)(Handle >> 8));
  _virtualPort->write((char)(Handle));
  _virtualPort->write((char)(Index >> 8));
  _virtualPort->write((char)(Index));
...
word Pixxi_Serial_4DLib::widget_Disable(word  Handle, word  Index)
{
  _virtualPort->write((char)(F_widget_Disable >> 8));
  _virtualPort->write((char)(F_widget_Disable));
  _virtualPort->write((char)(Handle >> 8));
  _virtualPort->write((char)(Handle));
  _virtualPort->write((char)(Index >> 8));
  _virtualPort->write((char)(Index));
...
word Pixxi_Serial_4DLib::widget_SetAttributes(word  Handle, word  Index, word  Value)
{
  _virtualPort->write((char)(F_widget_SetAttributes >> 8));
  _virtualPort->write((char)(F_widget_SetAttributes));
  _virtualPort->write((char)(Handle >> 8));
  _virtualPort->write((char)(Handle));
  _virtualPort->write((char)(Index >> 8));
  _virtualPort->write((char)(Index));
...
word Pixxi_Serial_4DLib::widget_ClearAttributes(word  Handle, word  Index, word  Value)
{
  _virtualPort->write((char)(F_widget_ClearAttributes >> 8));
  _virtualPort->write((char)(F_widget_ClearAttributes));
  _virtualPort->write((char)(Handle >> 8));
  _virtualPort->write((char)(Handle));
  _virtualPort->write((char)(Index >> 8));
  _virtualPort->write((char)(Index));
...
word Pixxi_Serial_4DLib::widget_Touched(word  Handle, word  Index)
{
  _virtualPort->write((char)(F_widget_Touched >> 8));
  _virtualPort->write((char)(F_widget_Touched));
  _virtualPort->write((char)(Handle >> 8));
  _virtualPort->write((char)(Handle));
  _virtualPort->write((char)(Index >> 8));
  _virtualPort->write((char)(Index));
...
void Pixxi_Serial_4DLib::widget_InitGradRAM(word hndl) {
  _virtualPort->write((char)(F_widget_InitGradRAM >> 8));
  _virtualPort->write((char)(F_widget_InitGradRAM));
  _virtualPort->write((char)(hndl >> 8));
  _virtualPort->write((char)(hndl));
  GetAck();  
}	

word Pixxi_Serial_4DLib::widget_InitString(char * str) {
  word len = strlen(str);
  word addr = mem_Alloc(len);
  SendByteArrayToRAM(addr, len, str);
  return addr;
}

word Pixxi_Serial_4DLib::widget_InitStringPtr(char * str) {  
  return str_Ptr(widget_InitString(str));
}

word Pixxi_Serial_4DLib::widget_InitStringArray(char * str, word len) {
  word addr = mem_Alloc(len);
  SendByteArrayToRAM(addr, len, str);
  addr = str_Ptr(addr);
  return addr;
...
void Pixxi_Serial_4DLib::widget_Init(word len, word * data, word * hndl, word * param) {
  *param = mem_Alloc(len << 1);
  SendWordArrayToRAM(*param, len, data);
  *hndl = mem_Alloc(24);  
}

word Pixxi_Serial_4DLib::str_Ptr(word buffer) {
  _virtualPort->write((char)(F_str_Ptr >> 8)) ;
  _virtualPort->write((char)(F_str_Ptr)) ;
  _virtualPort->write((char)(buffer >> 8)) ;
  _virtualPort->write((char)(buffer)) ;
  return GetAckResp();
}

void Pixxi_Serial_4DLib::SendWordArrayToRAM(word  hndl, word  length, word * data) {
  _virtualPort->write((char)(F_sendWordArrayToRAM >> 8)) ;
  _virtualPort->write((char)(F_sendWordArrayToRAM)) ;
  _virtualPort->write((char)(hndl >> 8)) ;
  _virtualPort->write((char)(hndl)) ;
  _virtualPort->write((char)(length >> 8)) ;
  _virtualPort->write((char)(length));
  WriteWords(data, length) ;
  GetAck() ;  
}

void Pixxi_Serial_4DLib::SendByteArrayToRAM(word  hndl, word  length, char * data) {
  _virtualPort->write((char)(F_sendByteArrayToRAM >> 8)) ;
  _virtualPort->write((char)(F_sendByteArrayToRAM)) ;
  _virtualPort->write((char)(hndl >> 8)) ;
  _virtualPort->write((char)(hndl)) ;
  _virtualPort->write((char)(length >> 8)) ;
  _virtualPort->write((char)(length));
...
unsigned long Pixxi_Serial_4DLib::GetBaudRate(word Newrate)
{
  unsigned long br ;
  switch(Newrate)
  {
...
bool Pixxi_Serial_4DLib::setbaudWait(word Newrate)
{
...
void Pixxi_Serial_4DLib::exSetBaudRateHndl(unsigned long newRate) {
  setBaudRateExternal(newRate);
}

void Pixxi_Serial_4DLib::hwSetBaudRateHndl(unsigned long newRate) {
...
#ifdef SoftwareSerial_h
void Pixxi_Serial_4DLib::swSetBaudRateHndl(unsigned long newRate) {
...
#ifdef AltSoftSerial_h
void Pixxi_Serial_4DLib::alSetBaudRateHndl(unsigned long newRate) {
